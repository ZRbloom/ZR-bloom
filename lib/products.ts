...
export const products: Product[] = [
  ...
  },
  {
    ...
    gallery: ["/products/calabazagengar-2.jpeg", "/products/calabazagengar-3.jpeg"],
    category: "Decoración",
    featured: true,
    description:
  ...
  {
    id: 21,
    name: "Placa personalizada para mascota",
    price: 12.0,
    image: "/products/placa-mascota.jpeg",
    category: "Mascotas",
    featured: true,
    description:
      "Placa identificativa para el collar de tu mascota, con el nombre y el teléfono de contacto grabados.",
    material: "PLA (bioplástico)",
    stock: { mode: "made_to_order", productionDays: 2 },
    personalization: [
      {
